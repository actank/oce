...
INCLUDE_DIRECTORIES( 
	...
	"/usr/src/kernels/2.6.18-128.el5-x86_64/include"
  ${XNS_ROOT_DIR}
	${ICE_HOME}/include
	...
	${XNS_ROOT_DIR}/third-party/include
	${XNS_ROOT_DIR}/third-party/google-breakpad/src
	${XNS_ROOT_DIR}/third-party/redis-c-driver/
	${XNS_ROOT_DIR}/third-party/apr/include/apr-1
	${XNS_ROOT_DIR}/third-party/include/ClearSilver/
	"/usr/include/uuid"
	${XNS_ROOT_DIR}/third-party/libactivemq/include/activemq-cpp-3.5.0
	...
	${XNS_ROOT_DIR}/tripod-new/src/cpp/include
  ${XNS_ROOT_DIR}/message_pipe/src/cpp
	)

LINK_DIRECTORIES( ${XNS_ROOT_DIR}/third-party/apr/lib /usr/lib64/nptl /usr/local/xce-dev/lib64 /usr/local/xce/lib64 /usr/local/xce/lib /opt/curl/lib ${XNS_ROOT_DIR}/depends/mysql++-3.0.6/	/opt/XiaoNei/mysqlpp_lib64/ 
  ~/3rdlibs/lib
  ~/lib/
	/usr/local/distcache-dev/lib
	/usr/local/distcache/lib
	/usr/local/distcache-util/lib
	${XNS_ROOT_DIR}/third-party/lib
	${XNS_ROOT_DIR}/third-party/libactivemq/lib
  )
