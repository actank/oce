...
public:
  EngineConfig(): DB_("ade_db"), sys_min_price_(100), X_(2), Y_(1),
                  ...
                  cost_discount_(0.85), rand_seed_(1500),ping_seq_size_(300), 

                  sort_type_(1), ctr_power_(1), price_power_(1),user_id_(-1),ad_blind_threshold_(50)
                  , url_encode_(0) , alpha_threshold_(2.5),test_impr_ratio_(0.05),state1_test_impr_ratio_(0.0),
                    state2_test_impr_ratio_(0.0),state3_test_impr_ratio_(0.0),
                    state1_reserved_test_impr_ratio_(0.2),state2_reserved_test_impr_ratio_(0.2),state3_reserved_test_impr_ratio_(0.2),
                  photo_wb1_count_(2),big_pic_ratio_75_(50),big_pic_id_(31), style_db_host_("10.3.23.69"), memcached_("10.7.18.60:11211 500,10.7.18.60:11212 500") {
