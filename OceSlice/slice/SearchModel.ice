...
module model
{
	...
	enum GroupType
	{
		GroupSearch,GroupBrowse,GroupGuide,TestGroupSearch,TestGroupBrowse,TestGroupGuide,Group22Search,Group65Search,Group22Browse,Group65Browse,Group22Guide,Group65Guide,GroupShare,TestGroupShareExternalSearch
	};
