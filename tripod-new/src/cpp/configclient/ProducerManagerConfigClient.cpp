...
ProducerManagerPrx ProducerManagerConfigClient::getJavaPrx() {

    return javaPrxHashHolder_.getRandom();
}

ProducerManagerPrx ProducerManagerConfigClient::getCcPrx() {

    return ccPrxHashHolder_.getRandom();
}
