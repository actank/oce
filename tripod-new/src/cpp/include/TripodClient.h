...
class TripodClient {
 ...
 public:
  ...
  bool LoadListCache(const std::string& key, bool use_master = true, const long timeout = 5000);
  bool DeleteListOrHashCache(const std::string& key, const long timeout = 5000);
