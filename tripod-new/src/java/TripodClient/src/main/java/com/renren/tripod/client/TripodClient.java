...
public class TripodClient implements ITripodClient {
	...
	public Map<String, byte[]> getWithMissed(List<String> keys, int expiredTime,
			boolean useMaster, int timeout) {
		List<String> missedKeys = new ArrayList<String>();
		Map<String, byte[]> res = get(keys, missedKeys);
		
		if(!missedKeys.isEmpty()) {
			Map<String, byte[]> missedRes = getMissed(missedKeys, expiredTime, useMaster, timeout);
	...
	public static void main(String[] args) {
		...
		List<String> missedKeys = new ArrayList<String>();
		Map<String, byte[]> res = tc.get(keys, missedKeys);
