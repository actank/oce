#ifndef PRESENCEMSGHANDLERADAPTER_H_
#define PRESENCEMSGHANDLERADAPTER_H_
...
class PresenceMsgHandlerAdapter : public MyUtil::AdapterI,
	public AdapterISingleton<MyUtil::TalkChannel, PresenceMsgHandlerAdapter> {
public:
	PresenceMsgHandlerAdapter() {
