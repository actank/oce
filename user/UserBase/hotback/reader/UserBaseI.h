...
class UserPassportManagerI : virtual public UserPassportReader , public MyUtil::Singleton<UserPassportManagerI>
{
public:
...
//-------------------------UserNameManagerI-------------------------------
class UserNameManagerI : virtual public UserNameReader, public MyUtil::Singleton<UserNameManagerI>
{
public:
...
//-------------------------UserRightManagerI-------------------------------
class UserRightManagerI : virtual public UserRightReader, public MyUtil::Singleton<UserRightManagerI>
{
public:
...
//-------------------------UserStateManagerI-------------------------------
class UserStateManagerI : virtual public UserStateReader, public MyUtil::Singleton<UserStateManagerI>
{
public:
...
class UserLoginCountManagerI : virtual public UserLoginCountReader, public MyUtil::Singleton<UserLoginCountManagerI>
{
public:
...
//----------------------------------------------------------------------------
class UserUrlManagerI : virtual public UserUrlReader, public MyUtil::Singleton<UserUrlManagerI>{
public:
	UserUrlManagerI() : valid_ (false) {
	}
	virtual UserUrlDataPtr getUserUrl(Ice::Int userId, const Ice::Current& = Ice::Current());
...
class UserBasicManagerI : virtual public UserBasicReader,  public MyUtil::Singleton<UserBasicManagerI>
{
public:
	UserBasicManagerI() : valid_(false){}
	virtual UserBasicDataNPtr getUserBasic(Ice::Int userId,	const Ice::Current& = Ice::Current());
...
public:
	void parseData(UserBasicDataIPtr& desData, const UserBornDataNPtr& bornData, 
...
class UserBornManagerI : virtual public UserBornReader, public MyUtil::Singleton<UserBornManagerI>
{
public:
	UserBornManagerI() : valid_(false){
	}
	virtual UserBornDataNPtr getUserBorn(Ice::Int userId,	const Ice::Current& = Ice::Current());
...
class UserStageManagerI : virtual public UserStageReader,  public MyUtil::Singleton<UserStageManagerI>
{
public:
...
class UserDoingManagerI : virtual public UserDoingReader,  public MyUtil::Singleton<UserDoingManagerI>
{
public:
...
class UserBaseViewManagerI : virtual public UserBaseViewReader, public MyUtil::Singleton<UserBaseViewManagerI>
{
public:
	UserBaseViewManagerI() : valid_ (false) {}
	
    virtual UserBaseViewDataNPtr getUserBaseView( Ice::Int userId,
                                        	  const Ice::Current& = Ice::Current());
	virtual UserCommonViewDataPtr getUserCommonView(int userId, 
			                                  const Ice::Current& = Ice::Current());
	...
	void setValidForce(bool valid, const Ice::Current& = Ice::Current());
private:
	UserBasicDataIPtr parseToUserBasicData( const int userId,
