<li class="clearfix" id="commonFriend_{{ID}}" onmouseover="Sizzle('a.shut-new',this)[0].style.display='block'" onmouseout="Sizzle('a.shut-new',this)[0].style.display='none'">
	...
	<span>
		...
		<p><a href="javascript:;" onclick="XN.app.pymk.showProfile('{{ID}}');logRcd({action:'frtPage_recommend_P_info',guest_id:{{ID}}});">查看资料</a><span class="pymk-type">({{FIELD}}个共同好友)</span></p>	
	</span>	
